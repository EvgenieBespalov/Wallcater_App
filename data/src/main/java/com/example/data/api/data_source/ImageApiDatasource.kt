...
interface ImageApiDatasource {
    @GET("/images/search?mime_types=jpg,png&order=ASC&limit=10&has_breeds=false&include_breeds=false&include_categories=false&api_key=live_YleQhfhS8ytOzT8IbcFnV72Vs71UZA02d7WieOCqyabZdofsI5kDZhbWD57p1OfQ")
